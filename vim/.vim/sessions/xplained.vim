...
set modelines=0
set ruler
set runtimepath=~/.vim,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/lightline.vim,~/.vim/bundle/tagbar,~/.vim/bundle/vim-gdscript3,~/.vim/bundle/vim-gitgutter,~/.vim/bundle/vim-signature,~/.vim/bundle/wal.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/bundle/vim-signature/after,~/.vim/after
set scrolloff=3
set shiftwidth=4
set showcmd
set showmatch
...
argglobal
%argdel
$argadd .zerynth2_test/dist/r2.2.0/libs/official/googlecloud/iot/iot.py
edit .zerynth2_test/dist/r2.2.0/libs/official/googlecloud/iot/iot.py
...
wincmd w
argglobal
if bufexists("Code/Zerynth/libs/microchip-winc1500/csrc/winc.c") | buffer Code/Zerynth/libs/microchip-winc1500/csrc/winc.c | else | edit Code/Zerynth/libs/microchip-winc1500/csrc/winc.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> ,hp <Plug>GitGutterPreviewHunk
nmap <buffer> ,hu <Plug>GitGutterUndoHunk
...
exe 'vert 2resize ' . ((&columns * 86 + 86) / 173)
tabnext 1
badd +1 .zerynth2_test/dist/r2.2.0/libs/official/googlecloud/iot/iot.py
badd +77 .zerynth2_test/dist/r2.2.0/libs/official/zerynth/mqtt/mqtt.py
badd +0 Code/Zerynth/libs/microchip-winc1500/csrc/winc.c
